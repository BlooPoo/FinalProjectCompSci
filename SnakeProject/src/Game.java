...
public class Game extends JPanel implements ActionListener {
	...
	/**
	 * spawn {@link Food} random on the grid
	 */
	...
	/**
	 * create a grid with positions for the {@link Food} to be drawn on
	 */
	...
	/**
	 * check in the snake either collides with a wall, {@link Food} or itself, stop
	 * the game if true
	 */
	...
	public void actionPerformed(ActionEvent e) {
		...
		// important so the method gets repeated and everything is redrawn after it
		// moved
		repaint();
	}
